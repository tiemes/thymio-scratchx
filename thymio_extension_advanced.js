...
*/
    ...
    var blocks = {
        ...
        de: [
            [" ", "Motor %m.leftrightall %n", "scratch_motor", "left", 50],
            [" ", "Motoren stoppen", "scratch_stop"],
            ["w", "fahre %n", "scratch_move", 50],
            ["w", "fahre %n with speed %n", "scratch_move_with_speed", 50, 50],
            ["w", "fahre %n in %n s", "scratch_move_with_time", 50, 1],
            ["w", "drehe %n", "scratch_turn", 45],
            ["w", "drehe %n mit Geschwindigkeit %n", "scratch_turn_with_speed", 90,50],
            ["w", "drehe %n in %n s", "scratch_turn_with_time", 90,1],
            ["r", "Näherungssensor %n", "proximity", 2],
            ["r", "Bodensensor %n", "ground", 0],
            ["r", "distance %m.sensors", "distance", "front"],
            ["r", "angle %m.angles", "angle", "front"],
            ["b", "objet détecté %m.sensors", "touching", "devant"],
            ["b", "objet détecté %m.sensors %n", "touching_threshold", "devant"],
